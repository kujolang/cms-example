...
CMS_EXTENSION_INBOX_DIR="${PROJECT_DIR}/.data/extensions/inbox" \
CMS_EXTENSION_STORE_DIR="${PROJECT_DIR}/.data/extensions/installed" \
CMS_MEDIA_INBOX_DIR="${PROJECT_DIR}/.data/media/inbox" \
CMS_MEDIA_STORE_DIR="${PROJECT_DIR}/.data/media/store" \
CMS_MEDIA_PUBLIC_BASE_URL=/media \
CMS_PLUGIN_HOOK_ALLOW_HTTP=true \
CMS_PLUGIN_RUNTIME_ALLOW_PRIVATE=true \
CMS_PLUGIN_HOOK_URL_ALLOWLIST=127.0.0.1 \
