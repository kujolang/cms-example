...
type Ability = { name: string; label: string; description: string; category: string; permission: string; enabled: boolean; manageable: boolean; source: string; source_name?: string; annotations: { readonly: boolean; destructive: boolean; idempotent: boolean; requires_confirmation: boolean } };
